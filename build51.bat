...
%LINK86% /DLL /EXPORT:luaopen_LuaWinCon /LIBPATH:%DDK%\lib\win7\i386 /LIBPATH:%DDK%\lib\Crt\i386 /LIBPATH:%LuaP%\lib /LIBPATH:%SDK%\Lib /DEFAULTLIB:lua51.lib LuaWinCon.obj luaW.obj /OUT:LuaWinCon.dll
)

if exist LuaWinCon51.dll (
del LuaWinCon51.dll
)
rename LuaWinCon.dll LuaWinCon51.dll
